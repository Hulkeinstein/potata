                    ...
                    <AnimatePresence mode="wait">
                        {!showEmailForm ? (
                            ...
                            >
                                ...
                                {/* Apple */}
                                <button className="w-full h-12 bg-zinc-800 text-white font-bold rounded-lg flex items-center justify-center gap-2 border border-zinc-700 transition-transform hover:scale-[1.02]">
